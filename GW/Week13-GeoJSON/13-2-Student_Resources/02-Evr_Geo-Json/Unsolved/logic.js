...
function createFeatures(element){
  ...
  function onEachFeature1(feature, layer){
    layer.bindPopup("<h3>" + feature.properties.place+ "</h3> <hr> <h5>" +new Date(feature.properties.time) + "</h5>")
    ...
    var earthquake = L.geoJSON(element, {
      onEachFeature: onEachFeature1
    });

    // 7. Send the earthquake layer to the createMap function
